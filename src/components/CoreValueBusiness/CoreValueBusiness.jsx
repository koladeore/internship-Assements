...
import './CoreValueBusiness.scss';
import { images } from '../../constants';

const CoreValueBusiness = () => {
  return (
    <div>
      <div className="coreValue_Header">
        <div className="businessHeaderContentImage">
          <img src={images.businessHeaderContent} alt="" />
        </div>
...
export default CoreValueBusiness;
